...
public interface Reporter {
    ...
    void report(DebtCollection debtCollection, DebtReportingProperties debtReportingProperties) throws IOException;

    Set<String> getSupportedOptions();

    void reportDebtInfo(DebtInstanceInfo debtInstanceInfo);
}
