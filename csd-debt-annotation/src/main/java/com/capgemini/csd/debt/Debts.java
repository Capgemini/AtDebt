...
/**
 * An Annotation to track multiple instances of {@code Debt} annotations
 * on an element. Use this if two or more <b>different</b> instances of 
 * technical debt occur for an element.
 * 
...
public @interface Debts {
    ...
    /**
     * An array of {@link Debt} instances.
     *
     * @return the array of {@code Debt} instances
     */
    Debt[] value();
}